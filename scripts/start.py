...
class AITutorStarter:
    ...
    def __init__(self):
        ...
        try:
            ...
            logger.error(str(e))
            logger.error("Please configure LLM settings in .env or OpenTutor.env file")
            sys.exit(1)

        # Load knowledge base list
        self.available_kbs = self._load_available_kbs()

        logger.section("OpenTutor Intelligent Teaching Assistant System")
        ...
        while True:
            try:
                ...
                if choice == "1":
                    ...
                    print("\n" + "=" * 70)
                    print("👋 Thank you for using OpenTutor Intelligent Teaching Assistant System!")
                    print("=" * 70)
                    break

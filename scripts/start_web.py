...
def start_frontend():
    ...
    api_base_url = os.environ.get("NEXT_PUBLIC_API_BASE_EXTERNAL") or \
                   os.environ.get("NEXT_PUBLIC_API_BASE") or \
    ...
    try:
        with open(env_local_path, "w", encoding="utf-8") as f:
            ...
            f.write("# and environment variables (NEXT_PUBLIC_API_BASE, NEXT_PUBLIC_API_BASE_EXTERNAL)\n")
            f.write("# \n")

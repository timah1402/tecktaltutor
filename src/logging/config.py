...
def load_logging_config() -> LoggingConfig:
    ...
    """
    try:
        from src.services.config import load_config_with_main, get_path_from_config
        ...
        return LoggingConfig(
            ...
            lightrag_forwarding_enabled=logging_config.get("lightrag_forwarding", {}).get("enabled", True),
            lightrag_min_level=logging_config.get("lightrag_forwarding", {}).get("min_level", "INFO"),
            lightrag_add_prefix=logging_config.get("lightrag_forwarding", {}).get("add_prefix", True),
        )
    except Exception:
        return LoggingConfig()
